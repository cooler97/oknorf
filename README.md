...
### Исправлено
- Цены на материалы
- Заблокирована возможность расчета противовзломной фурнитуры с двумя диагоналями для Roto

[2020-08-13]
### Добавлено
- Дверная фурнитура выделена в отдельный класс

[2020-06-19]
### Исправлено
- При автоматическом списывание монтажных лент, ленты добавленные в ручную удалялись
